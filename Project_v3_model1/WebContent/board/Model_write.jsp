...
<br /><br /><br />
<table align="center">
<form name=writeform method=post action="Model_write_ok.jsp">
  <tr>
   <td>
   ...
   <table>
     <tr>
	      ...
	      <td><input type="text" name="txtTitle" size="50" maxlength="100"></td>
	      <td>&nbsp;</td>
     </tr>
     ...
     <tr>
	      ...
	      <td><input type="password" name="txtPwd" size="50" maxlength="50"></td>
	      <td>&nbsp;</td>
     </tr>
     <tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
     <tr>
